...
namespace VET_ANIMAL_API.Migrations
{
    ...
    [Migration("20240430011538_AnimalVet0011")]
    partial class AnimalVet0011
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.Catalog", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdCatalog"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.CatalogItem", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdCatalogItem"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.Form", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdForm"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.FormSectionQuestion", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdFormSectionQuestion"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.Item", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdItem"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.Question", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdQuestion"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.QuestionType", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdQuestionType"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.DinamicQuestionEntities.Section", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdSection"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.Mascota", b =>
                {
                    ...
                    b.Property<long?>("RazaNuevaIdRaza")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.Razas", b =>
                {
                    b.Property<long>("IdRaza")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdRaza"));
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.TablaContenido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdFichaHemo")
                        .IsUnique();

                    b.ToTable("TablaContenido", "DET");
                });
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.Veterinario", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("VET_ANIMAL_API.Entities.FichaHemoparasitosis", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("IdFichaHemo"));

                    b.Property<bool>("Activo")
                        .HasColumnType("boolean");

                    b.Property<string>("CodigoFichaHemo")
                        .HasColumnType("text");
                    ...
                    b.Property<long?>("FichaControlIdFichaControl")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("IdFichaHemo");

                    b.HasIndex("FichaControlIdFichaControl");
                    ...
                    b.ToTable("FichaHemoparasitosis", "DET");
                });
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.Mascota", b =>
                {
                    ...
                    b.HasOne("ProyectoBaseNetCore.Entities.Razas", "RazaNueva")
                        .WithMany("Mascotas")
                        .HasForeignKey("RazaNuevaIdRaza");

                    b.Navigation("Cliente");

                    b.Navigation("RazaNueva");
                });
            ...
            modelBuilder.Entity("ProyectoBaseNetCore.Entities.TablaContenido", b =>
                {
                    b.HasOne("VET_ANIMAL_API.Entities.FichaHemoparasitosis", "FichaHemoparasitosis")
                        .WithOne("TablaContenido")
                        .HasForeignKey("ProyectoBaseNetCore.Entities.TablaContenido", "IdFichaHemo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VET_ANIMAL_API.Entities.FichaHemoparasitosis", b =>
                {
                    b.HasOne("VET_ANIMAL_API.Entities.FichaControl", "FichaControl")
                        .WithMany("FichaHemoparasitosis")
                        .HasForeignKey("FichaControlIdFichaControl");
